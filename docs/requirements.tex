...
\begin{enumerate}[{BE}1.]
	...
	\begin{enumerate}[{VP2}.1]
		\item User
			\begin{enumerate}
				\item \textbf{User} is prompted to create a unique username, set a password, select their gender, enter their date of birth, and enter their phone number.
...
\begin{enumerate}[{LR}1. ]
	\item The product shall have an intuitive layout, it will take the \textbf{User} no longer than 10 minutes to learn to use. 
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{UPR}1. ]
	\item The product shall be clear to understand and shall not contain profane language. 
\end{enumerate}
% End SubSubSection
