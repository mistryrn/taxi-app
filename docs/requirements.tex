...
\begin{enumerate}[{BE}1.]
	...
	\begin{enumerate}[{VP10}.1]
		...
		\item Security
			\begin{enumerate}
				\item Blacklisted user will no longer be able to send/receieve offers/requests to/from the user who added them to their \textbf{\emph{Blacklist}}.
			\end{enumerate}
		\item Legal
			\begin{enumerate}
	...
	\begin{enumerate}[{VP11}.1]
		...
		\item Security
			\begin{enumerate}
				\item Un-Blacklisted user will now be able to send/receieve offers/requests to/from the user who added them to their \textbf{\emph{Blacklist}}.
			\end{enumerate}
		\item Legal
			\begin{enumerate}
