...
% Begin SubSection
All existing taxi applications only serve users by requesting a new taxi from the dispatcher, making our product independent and self-contained. Our application is intended to be used as 
...
\begin{enumerate}[{BE}1.]
	...
	\begin{enumerate}[{VP2}.1]
		\item User
			\begin{enumerate}
				\item The android application will close.
	...
	\begin{enumerate}[{VP2}.1]
		\item User
			\begin{enumerate}
				\item The offer/request made is canceled.
			\end{enumerate}
		\item Dispatcher
			\begin{enumerate}
	...
	\begin{enumerate}[{VP2}.1]
		\item User
			\begin{enumerate}
				...
				\item Auto add the friend to friends list of both users once the request is accepted.
			\end{enumerate}
		\item Dispatcher\\
			N.A.
		\item Security
		...
		\item Legal
			\begin{enumerate}
				\item Notify users profile information will be shared between friends.
			\end{enumerate}
	\end{enumerate}
	...
	\begin{enumerate}[{VP2}.1]
		...
		\item Legal
			\begin{enumerate}
				\item Notify the user that removed friend's profile will no longer be accessed.
			\end{enumerate}
	\end{enumerate}
